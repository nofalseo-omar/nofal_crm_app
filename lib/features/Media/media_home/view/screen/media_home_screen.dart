...
import 'package:nofal_crm_app/features/Media/media_home/view/widgets/dialogs/create_campign_dialog.dart';
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                children: [
                  CustomAppBarWidget(onTapAdd: () {
                    showDialog(
                        context: context,
                        builder: (context) => AlertDialog(
                              content: const CreateCampignDialog(),
                            ));
                  }),
                  8.verticalSpace,
                  Expanded(
